...
public class RendererPedestal extends TileEntitySpecialRenderer<TileEntityPedestal>
{
    ...
    /* (non-Javadoc)
     * @see net.minecraft.client.renderer.tileentity.TileEntitySpecialRenderer#render(net.minecraft.tileentity.TileEntity, double, double, double, float, int, float)
     */
    @Override
            ...
            float alpha)
    {
        ...
        if (!itemStack.isEmpty())
        {
            ...
            IBakedModel model = Minecraft.getMinecraft().getRenderItem().getItemModelWithOverrides(itemStack, te.getWorld(), null);
